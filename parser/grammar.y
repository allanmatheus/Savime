...
| value_expression SIGNED_EXACT_NUMBER {$$ = new ValueExpressionPtr (new SummationNumericExpression(*$1, atof($2))); delete $1;} 
...
EXACT_NUMBER  {$$ = new UnsignedNumericLiteralPtr (new UnsignedNumericLiteral(atof($1)));}
| APROX_NUMBER {$$ = new UnsignedNumericLiteralPtr (new UnsignedNumericLiteral(atof($1)));}
;

signed_numeric_literal:
 SIGNED_EXACT_NUMBER {$$ = new SignedNumericLiteralPtr (new SignedNumericLiteral(atof($1)));}
| SIGNED_APROX_NUMBER {$$ = new SignedNumericLiteralPtr (new SignedNumericLiteral(atof($1)));}
;

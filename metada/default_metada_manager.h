...
class DefaultMetadataManager : public MetadataManager, public MetadataObjectListener
{
    int32_t _id = 1;
...
public:
    ...
    DefaultMetadataManager(ConfigurationManagerPtr configurationManager, SystemLoggerPtr systemLogger);

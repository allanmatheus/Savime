...
public:
    ...
    */
    Optimizer(ConfigurationManagerPtr configurationManager, SystemLoggerPtr systemLogger) :
    ...
    * @param queryDataManager is a QueryDataManager reference containing the QueryPlan.
